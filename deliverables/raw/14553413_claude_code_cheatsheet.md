# Claude Code cheatsheet | Claude Help Center
...
| **Command** | Any input starting with /. Built-in commands control the session (see the table below); custom ones are skills your team defines in `.claude/skills//SKILL.md` (the legacy `.claude/commands/` path still works). |
