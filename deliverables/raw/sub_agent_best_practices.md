...
For the complete sub-agent orchestration system, including the full invocation protocol and specialist agent definitions, check out the [Code Kit](/).
...
![Claude Fast Shopify Kit](/_next/image?url=%2Fimages%2Fshopify%2Fannouncement-hero.png&w=3840&q=75)

Shopify Kit just dropped

Turn Claude into a 20-person Shopify consultancy. CRO, paid, retention, ops, SEO. $199 lifetime.
