...
2. ANALYSE: Read all collected files. Identify overlapping advice, deduplicate, and cluster into 6-8 major themes. Rank tips within each theme by how often they appear across sources. Save the analysis to deliverables/analysis.md.
